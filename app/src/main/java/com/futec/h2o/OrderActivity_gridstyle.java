...
public class OrderActivity_gridstyle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_layout_grid);
        ...
        no_col_items=sharedPreferences.getInt("", 4);
        ...
        try {
            ...
            gridAdapterMenu adapter = new gridAdapterMenu(context, categNamesEN);
            ...
            fab_cancel.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    for (int i = 0; i < size; i++) {
                        ...
                        if (print)
                        AppMsg.makeText(OrderActivity_gridstyle.this,
                                "Cant delete a table with prepared items",
            ...
            holder.qyt_tv.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (isPrinted1.get(id).equalsIgnoreCase("true") || isPrinted2.get(id).equalsIgnoreCase("true")
                        ...
                        AppMsg.makeText(OrderActivity_gridstyle.this, "Cant change quantity of prepared item",
                                AppMsg.STYLE_ALERT, (float)fontsize)
                                .setAnimation(slide_down, slide_up).show();
                    }else
                    {   invoiceListIndex=id;
            ...
            holder.add_note_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (isPrinted1.get(invoiceListIndex).equalsIgnoreCase("true") || isPrinted2.get(invoiceListIndex).equalsIgnoreCase("true")
                        ...
                        AppMsg.makeText(OrderActivity_gridstyle.this,
                                "Cant add flavor to a prepared item",
                                AppMsg.STYLE_ALERT, (float)fontsize)
                                .setAnimation(slide_down, slide_up).show();
                    }
                    else
    ...
    public void createInvoice(JSONArray jArray){
        ...
        invoiceListAdapter adapter = new invoiceListAdapter(OrderActivity_gridstyle.this, lineIDs);
    ...
    private  void showFlavorDialog(){
        ...
        if (selectedflavorNameEn.size() > 1) {
            ...
            flavorsGridAdapter adapter = new flavorsGridAdapter(OrderActivity_gridstyle.this,
