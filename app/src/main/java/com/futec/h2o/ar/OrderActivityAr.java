...
public class OrderActivityAr extends AppCompatActivity {
    ...
    //GridLayout.LayoutParams paramsName, paramsPrice, paramsQyt,paramsTotal, paramsdelete;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_order_layout_ar);
        ...
        categMenuadapter adapter= new categMenuadapter(OrderActivityAr.this,1,categNamesAR);
        ...
        fab_cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isPrinted1!= null && isPrinted2!= null && isPrinted3!= null) {
                    ...
                    if (print)
                        AppMsg.makeText(OrderActivityAr.this, getResources().getString(R.string.prepered_table_ar),
            ...
            holder.qyt_tv.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (isPrinted1.get(id).equalsIgnoreCase("true") || isPrinted2.get(id).equalsIgnoreCase("true")
                        ...
                        AppMsg.makeText(OrderActivityAr.this, getResources().getString(
            ...
            holder.removeItem_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (isPrinted1.get(id).equalsIgnoreCase("true") || isPrinted2.get(id).equalsIgnoreCase("true")
                            || isPrinted3.get(id).equalsIgnoreCase("true")) {
                        AppMsg.makeText(OrderActivityAr.this, getResources().getString(
                                R.string.prepared_item_ar), AppMsg.STYLE_ALERT, (float)fontsize)
                        .setAnimation(slide_down, slide_up).show();
            ...
            holder.add_note_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (isPrinted1.get(invoiceListIndex).equalsIgnoreCase("true") || isPrinted2.get(invoiceListIndex).equalsIgnoreCase("true")
                        ...
                        AppMsg.makeText(OrderActivityAr.this, getResources().getString(
                                R.string.prepared_item_flavor), AppMsg.STYLE_ALERT, (float)fontsize)
                                .setAnimation(slide_down, slide_up).show();}
                    else
                    {
        ...
        protected void onPostExecute(String s) {
            ...
            switch (result_int) {
                case 0:
                    ...
                    break;
                case 2:
                    grandTotal_tv.setText(Msg_grandtotal+": 00.00");
                    invoiceListView.setAdapter(null);
                    break;
                case 4:
                    grandTotal_tv.setText(Msg_grandtotal+": "
                            +String.format("%.2f", Double.parseDouble(grandTotal)));
        ...
        protected void onPostExecute(String s) {
            ...
            switch (result_int) {
                ...
                case 1:
                    ...
                    break;
                case 3:
                    grandTotal_tv.setText(Msg_grandtotal+": " + grandTotal);
                    createInvoice(jArray);
                    break;
    ...
    public void createInvoice(JSONArray jArray){
        ...
        invoiceListAdapter adapter = new invoiceListAdapter(OrderActivityAr.this, lineIDs);
    ...
    private  void showFlavorDialog(){
        ...
        View promptView;
        LayoutInflater layoutInflater = LayoutInflater.from(OrderActivityAr.this);
